...
export function CartCheckoutBar() {
  ...
  return (
    <AnimatePresence>
      {visible && (
        <>
          {/* طبقة الـ constraint تغطي كامل الشاشة */}
          <div
            ref={constraintRef}
            style={{
              position: "fixed",
          ...
          <motion.div
            ...
            style={{
              position: "fixed",
              bottom: 117,   /* فوق شريط التنقل مباشرةً */
              right: 12,
              left: expanded ? "calc(12.5% + 27px)" : "auto",
              zIndex: 52,
              direction: "rtl",
              display: "flex",
