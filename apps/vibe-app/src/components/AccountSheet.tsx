            ...
            <div style={{
              ...
              <div style={{ textAlign: "center" }}>
                <div style={{
                  ...
                  background: "linear-gradient(145deg,var(--color-brand-400) 0%,var(--color-brand-600) 100%)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  margin: "0 auto 12px",
                  boxShadow: "0 4px 16px rgba(212,80,58,0.28)",
                }}>
              ...
              <form onSubmit={e => { void handleSubmit(e); }} noValidate style={{ display: "flex", flexDirection: "column" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: busy ? "#CCCCCC" : "linear-gradient(135deg,var(--color-brand-500) 0%,var(--color-brand-600) 100%)",
                    color: "#fff", fontFamily: "var(--font-main)", fontSize: 15, fontWeight: 700,
                    cursor: busy ? "not-allowed" : "pointer",
                    display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                    transition: "all 0.2s ease",
                    boxShadow: busy ? "none" : "0 5px 18px rgba(212,80,58,0.32)",
                  }}
                >
              ...
              <div style={{ marginTop: 18, paddingTop: 16, borderTop: "1px solid #EEEEEE", textAlign: "center" }}>
                {mode === "login" ? (
                  <p style={{ margin: 0, fontSize: 13.5, color: "#6B6560", fontFamily: "var(--font-main)" }}>
                    ليس لديك حساب؟{" "}
                    <button type="button" onClick={() => switchMode("register")} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--color-brand-500)", fontWeight: 700, fontSize: 13.5, fontFamily: "var(--font-main)", padding: 0, textDecoration: "underline", textUnderlineOffset: 3 }}>
                      أنشئ حساباً الآن
                    </button>
                  </p>
                ) : (
                  <p style={{ margin: 0, fontSize: 13.5, color: "#6B6560", fontFamily: "var(--font-main)" }}>
                    لديك حساب بالفعل؟{" "}
                    <button type="button" onClick={() => switchMode("login")} style={{ background: "none", border: "none", cursor: "pointer", color: "var(--color-brand-500)", fontWeight: 700, fontSize: 13.5, fontFamily: "var(--font-main)", padding: 0, textDecoration: "underline", textUnderlineOffset: 3 }}>
                      سجّل الدخول
                    </button>
                  </p>
                )}
              ...
              {resetOk ? (
                <div style={{ textAlign: "center", padding: "30px 0 14px" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ width: 42, height: 42, borderRadius: "50%", background: "linear-gradient(135deg,var(--color-brand-500),var(--color-brand-600))", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <form onSubmit={e => { void handleForgot(e); }}>
                  ...
                  <button type="submit" disabled={busy} style={{ width: "100%", padding: "14px 0", marginTop: 4, borderRadius: 13, border: "none", background: busy ? "#CCCCCC" : "linear-gradient(135deg,var(--color-brand-500) 0%,var(--color-brand-600) 100%)", color: "#fff", fontFamily: "var(--font-main)", fontSize: 14.5, fontWeight: 700, cursor: busy ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: busy ? "none" : "0 5px 18px rgba(212,80,58,0.32)" }}>
                ...
                <form onSubmit={e => { void handleReset(e); }}>
                  ...
                  {err && <div role="alert" style={{ display: "flex", alignItems: "flex-start", gap: 8, padding: "11px 13px", borderRadius: 11, background: "#FEF0EE", border: "1px solid #FECACA", marginBottom: 13 }}><span style={{ fontSize: 14, flexShrink: 0 }}>⚠️</span><p style={{ fontSize: 13, color: "#DC2626", margin: 0, fontFamily: "var(--font-main)", lineHeight: 1.5 }}>{err}</p></div>}
                  <button type="submit" disabled={busy} style={{ width: "100%", padding: "14px 0", borderRadius: 13, border: "none", background: busy ? "#CCCCCC" : "linear-gradient(135deg,var(--color-brand-500) 0%,var(--color-brand-600) 100%)", color: "#fff", fontFamily: "var(--font-main)", fontSize: 14.5, fontWeight: 700, cursor: busy ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 11, boxShadow: busy ? "none" : "0 5px 18px rgba(212,80,58,0.32)" }}>
