        ...
        <div style={{ position: "relative", display: "flex", height: "100%", zIndex: 1 }}>
          {navItems.map(({ id, label, Icon }, idx) => {
            ...
            return (
              ...
              >
                {/* ── Animated pill indicator — 28×3px, slides horizontally ── */}
                {isActive && (
                  <motion.div
                ...
                {isActive && (
                  ...
                  >
                    <Icon size={21} strokeWidth={2.2} style={{ color: BRAND_HEX }} />
                ...
                <span style={{
                  ...
                  color: isActive ? BRAND_HEX : INACTIVE,
