...
const mockProducts = [
  ...
  { id: 9,  name: "حقيبة شانيل كلاسيك",        brand: "CHANEL",   price: 2100, original_price: 2800, discount: 25, image: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400",  images: ["https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400","https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400"], is_new: false, rating: 5.0, sales: 290,  stock: 2,  colors: ["#2E2C2A","#F5F0E8","#C0A882"], sizes: [], description: "الحقيبة 2.55 من شانيل — أيقونة الموضة الفرنسية منذ عام 1955. تصميم تقليلي لا يتقادم بالجلد المبطن." },
...
router.get("/products", (req: Request, res: Response) => {
  const { q, brand, minPrice, maxPrice, minDiscount, minRating, color, size, inStock, isNew, sort, page, limit: limitQ } = req.query as Record<string, string | undefined>;
